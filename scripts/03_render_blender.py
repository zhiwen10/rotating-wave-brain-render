...
data_dir = "/Users/zhiwenye/Documents/UW/manuscript/science revision2/blender code/"
...
if "Cortex" in imported_objects:
    ...
    npy_path = os.path.join(data_dir, "vertex_colors.npy")
...
# ============================================================================
# 10. SAVE RENDER TO IMAGE (the specific saved angle)
# ============================================================================
# Set SAVE_RENDER = True to render the current camera view straight to a PNG.
# The camera location/rotation above are the saved angle. To capture a new
# angle, frame it in the viewport, run scripts/extract_camera_params.py to
# print fresh values, and paste them over the cam_obj.location / .rotation_euler
# lines in section 9.
SAVE_RENDER = True
RENDER_OUTPUT = os.path.join(data_dir, "rotating_wave_render.png")
