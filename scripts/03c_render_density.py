...
#                                (generated by scripts/generate_previews.py)
# ============================================================================
...
SAVE_RENDER   = True
RENDER_OUTPUT = os.path.join(data_dir, "render_density.png")
