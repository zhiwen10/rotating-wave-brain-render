...
# Requires root.obj, isocortex.obj, and vertex_colors.npy (or
# vertex_colors_density.npy) in data_dir.
# ============================================================================

# --- Data directory (EDIT THIS) ---
data_dir = "."   # folder containing root.obj, isocortex.obj, vertex_colors.npy

# --- Which vertex color file to use ---
VERTEX_COLORS_FILE = "vertex_colors.npy"          # phase map
# VERTEX_COLORS_FILE = "vertex_colors_density.npy"  # density map
